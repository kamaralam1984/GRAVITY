...
export const metadata: Metadata = {
  title: 'Elderly Monitoring App — Gravity | Fall Detection & Caregiver Dashboard',
  description:
    "Monitor elderly parents with Gravity's senior safety app. Fall detection, medication reminders, wellness tracking, caregiver alerts. Peace of mind 24/7.",
  keywords: [
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Elderly Monitoring App — Gravity',
      },
    ],
    locale: 'en_IN',
    type: 'website',
