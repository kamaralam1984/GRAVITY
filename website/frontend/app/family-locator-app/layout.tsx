...
export const metadata: Metadata = {
  title: 'Family Locator App — Gravity | Find Any Family Member Instantly',
  description:
    "Find any family member's real-time location instantly with Gravity Family Locator. GPS accuracy within 3 meters. Works in 127 countries.",
  keywords: [
    'family locator app',
    'find my family app',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Family Locator App — Gravity',
      },
    ],
    locale: 'en_IN',
    type: 'website',
