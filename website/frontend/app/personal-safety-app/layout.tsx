...
export const metadata: Metadata = {
  title: 'Personal Safety App — Gravity | Solo Travel & Emergency Protection',
  description:
    'Stay safe alone with Gravity. Journey sharing, SOS alerts, check-in reminders, fake call feature. The #1 personal safety app for solo travelers.',
  keywords: [
    'personal safety app',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Personal Safety App — Gravity',
      },
    ],
    locale: 'en_IN',
    type: 'website',
