...
export const metadata = {
  ...
  title: {
    default: "Gravity — What Pulls You Together | Family Safety App",
    template: "%s | Gravity by Trackalways",
  },
  description: "Gravity is the family safety platform that keeps your loved ones connected with real-time location sharing, SOS alerts, geofence zones, and AI-powered insights. Stay safe, stay together.",
  keywords: ["family safety", "GPS tracking", "location sharing", "SOS alert", "geofence", "elderly care", "Trackalways", "Gravity app"],
  ...
  openGraph: {
    ...
    title: "Gravity — What Pulls You Together",
    description: "Real-time family location sharing, SOS alerts, and smart geofencing. Know your family is safe, always.",
    images: [{ url: "/og-image.svg", width: 1200, height: 630, alt: "Gravity Family Safety" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Gravity — Family Safety App",
