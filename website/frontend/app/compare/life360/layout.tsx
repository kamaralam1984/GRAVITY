...
export const metadata: Metadata = {
  title: 'Gravity vs Life360 — Which Family Tracker is Better?',
  description:
    'Detailed comparison of Gravity and Life360. See why Indian families choose Gravity for better accuracy, lower cost, and India-first features.',
  keywords: [
    'Gravity vs Life360',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Gravity vs Life360 Comparison',
      },
    ],
    locale: 'en_IN',
    type: 'website',
